...
-- Started on 2017-06-05 23:38:49 BRT
...
8	Prefeitura	de Itajubá	prefeitura@itajuba.gov	123	\N	male	1995-11-02	Rua BPS	11	Centro	Itajubá	Minas Gerais	Brasil	4899322	0	0	manager	\N	\N	\N	t	f	f	f	t	t	t	t	t
9	Moderador	do fórum	moderador@email.com.br	123	\N	male	2001-10-11	Rua A	10	Parque	Piranguinho	Minas Gerais	Brasil	1111233	0	0	moderator	\N	\N	\N	t	t	t	t	t	t	t	t	t
\.
...
--
-- TOC entry 2269 (class 2606 OID 74292)
...
--
-- TOC entry 2268 (class 2606 OID 74287)
...
--
-- TOC entry 2270 (class 2606 OID 74477)
-- Name: comments_proposal_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_proposal
    ADD CONSTRAINT comments_proposal_author_id_fkey FOREIGN KEY (author_id) REFERENCES users(id) ON DELETE SET NULL;


--
-- TOC entry 2271 (class 2606 OID 74482)
-- Name: comments_proposal_proposal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_proposal
    ADD CONSTRAINT comments_proposal_proposal_id_fkey FOREIGN KEY (proposal_id) REFERENCES proposals(id) ON DELETE CASCADE;


--
-- TOC entry 2273 (class 2606 OID 74492)
-- Name: comments_proposal_reactions_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_proposal_reactions
    ADD CONSTRAINT comments_proposal_reactions_comment_id_fkey FOREIGN KEY (comment_id) REFERENCES comments_proposal(id) ON DELETE CASCADE;


--
-- TOC entry 2272 (class 2606 OID 74487)
-- Name: comments_proposal_reactions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_proposal_reactions
    ADD CONSTRAINT comments_proposal_reactions_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL;


--
-- TOC entry 2275 (class 2606 OID 74502)
-- Name: comments_proposal_reports_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_proposal_reports
    ADD CONSTRAINT comments_proposal_reports_comment_id_fkey FOREIGN KEY (comment_id) REFERENCES comments_proposal(id) ON DELETE CASCADE;


--
-- TOC entry 2274 (class 2606 OID 74497)
-- Name: comments_proposal_reports_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_proposal_reports
    ADD CONSTRAINT comments_proposal_reports_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL;


--
-- TOC entry 2276 (class 2606 OID 74507)
-- Name: comments_question_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_question
    ADD CONSTRAINT comments_question_author_id_fkey FOREIGN KEY (author_id) REFERENCES users(id) ON DELETE SET NULL;


--
-- TOC entry 2277 (class 2606 OID 74512)
-- Name: comments_question_question_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_question
    ADD CONSTRAINT comments_question_question_id_fkey FOREIGN KEY (question_id) REFERENCES questions(id) ON DELETE CASCADE;


--
-- TOC entry 2279 (class 2606 OID 74522)
-- Name: comments_question_reactions_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_question_reactions
    ADD CONSTRAINT comments_question_reactions_comment_id_fkey FOREIGN KEY (comment_id) REFERENCES comments_question(id) ON DELETE CASCADE;


--
-- TOC entry 2278 (class 2606 OID 74517)
-- Name: comments_question_reactions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_question_reactions
    ADD CONSTRAINT comments_question_reactions_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL;


--
-- TOC entry 2281 (class 2606 OID 74532)
-- Name: comments_question_reports_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_question_reports
    ADD CONSTRAINT comments_question_reports_comment_id_fkey FOREIGN KEY (comment_id) REFERENCES comments_question(id) ON DELETE CASCADE;


--
-- TOC entry 2280 (class 2606 OID 74527)
-- Name: comments_question_reports_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY comments_question_reports
    ADD CONSTRAINT comments_question_reports_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL;


--
-- TOC entry 2283 (class 2606 OID 74447)
...
--
-- TOC entry 2282 (class 2606 OID 74442)
...
--
-- TOC entry 2285 (class 2606 OID 74542)
...
--
-- TOC entry 2284 (class 2606 OID 74537)
...
--
-- TOC entry 2287 (class 2606 OID 74552)
...
--
-- TOC entry 2286 (class 2606 OID 74547)
...
--
-- TOC entry 2288 (class 2606 OID 74557)
...
--
-- TOC entry 2289 (class 2606 OID 74562)
...
--
-- TOC entry 2290 (class 2606 OID 74567)
...
--
-- TOC entry 2291 (class 2606 OID 74572)
...
--
-- TOC entry 2292 (class 2606 OID 74577)
...
--
-- TOC entry 2293 (class 2606 OID 74582)
...
--
-- TOC entry 2300 (class 2606 OID 74587)
...
--
-- TOC entry 2299 (class 2606 OID 74282)
...
--
-- TOC entry 2295 (class 2606 OID 74467)
...
--
-- TOC entry 2296 (class 2606 OID 74472)
...
--
-- TOC entry 2294 (class 2606 OID 74462)
...
--
-- TOC entry 2298 (class 2606 OID 74457)
...
--
-- TOC entry 2297 (class 2606 OID 74452)
...
-- Completed on 2017-06-05 23:38:50 BRT
